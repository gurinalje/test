...
public class StatisticsController {
    ...
    // 👇 修复了路径：前面加上了 statistics/ 完美对齐！
    @RequestMapping(value = "statistics/hall/stats", method = RequestMethod.GET)
    public ResponseVO getHallStats() {
        return statisticsService.getHallTicketStats();
    }
